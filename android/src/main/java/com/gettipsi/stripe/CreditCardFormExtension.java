...
public class CreditCardFormExtension extends RelativeLayout {
  ...
  public CreditCardFormExtension(Context context, AttributeSet attrs, boolean isZipAvailable) {
    ...
    if (!isInEditMode()) {
      ...
      if (attrs != null) {
        ...
        try {
          ...
          // do not include from xml since this changes dynamically
          this.includeZip = isZipAvailable;
